...
public class MoxiClient3{
	...
	public interface OssModel{
		 ...
		 * @return oss上的文件url
		 */
		@RequestLine("POST /moxi-0.0.0.1/oss/save2cloud?myname={myname}&base64str={base64str}")
		 ...
		 * @return oss上的文件url
		 */
		@RequestLine("POST /moxi-0.0.0.1/oss/save2cloud?myname={myname}&base64str={base64str}&home={home}")
		 ...
		 * @return oss上的文件url
		 */
		@RequestLine("POST /moxi-0.0.0.1/oss/list?path={path}")
		public ResultMessage list(@Param("path")String path);
	...
	/**
	 * 需要修改 nginx.conf http 模块下的下的,client_header_buffer_size 1000k;client_max_body_size 1m;
	 * @param args
	 */
	public static void main(String args[]) {
		String appurl = "http://www.yichem365.com3/plugin/api";
		String appurl2 = "http://www.yichem365.com3:8082"; // 引用外网链接
		OssModel ossModel = Endpoint.getClient(appurl2,OssModel.class);// 获取微服务客户端
		...
		OssModel.ResultMessage m = ossModel.list("test/gbench/moxi/thumbnail/$date/");
